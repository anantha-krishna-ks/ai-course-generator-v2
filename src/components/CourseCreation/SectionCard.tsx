      ...
      >
        ...
        <div className="flex-1 flex items-center gap-2.5 py-2.5 pr-3 pl-2.5 rounded-xl border border-border/60 bg-card shadow-[0_1px_2px_0_rgba(0,0,0,0.03)] hover:border-border hover:shadow-sm transition-all duration-150 min-w-0 my-0.5">
          ...
          {hasPageScope && (
            ...
            >
              <ListChecks className="w-2.5 h-2.5 text-primary" aria-hidden="true" focusable="false" />
            </button>
          )}
          <button
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48 bg-background border border-border p-1.5 z-50">
              ...
              >
                <ListChecks className="w-4 h-4 text-muted-foreground" aria-hidden="true" focusable="false" />
            ...
            <div className="pl-5 pr-4 pt-3.5 pb-3 flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 shrink-0">
                {hasScope && (
                  ...
                  >
                    <ListChecks className="w-3.5 h-3.5" aria-hidden="true" focusable="false" />
                  </button>
                )}
                <button
                  onClick={() => {
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="w-7 h-7 rounded-lg border border-border bg-muted/50 hover:bg-muted data-[state=open]:bg-primary/10 data-[state=open]:border-primary/30 flex items-center justify-center transition-colors shrink-0 group/trigger" aria-label="More section options">
                      <MoreHorizontal className="w-4 h-4 text-foreground group-data-[state=open]/trigger:text-primary transition-colors" aria-hidden="true" focusable="false" />
                    </button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent align="end" className="w-52 bg-background border border-border p-1.5">
                    ...
                    <DropdownMenuItem
                      ...
                      className="cursor-pointer gap-3 px-3 py-2.5 hover:!bg-muted focus:!bg-muted focus:!text-foreground"
                    >
                      <ExternalLink className="w-4 h-4 text-muted-foreground" aria-hidden="true" focusable="false" />
                      Open section
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onClick={onDuplicate}
              ...
              <div className="overflow-hidden">
                <div className="pl-5 pr-4 pb-3">
                  <div className="flex items-center gap-2 rounded-lg bg-accent/40 px-3 py-2.5">
                    <BookOpen className="w-3.5 h-3.5 text-primary shrink-0" aria-hidden="true" focusable="false" />
                    <input
                      ref={objectiveRef}
                      type="text"
                      value={objectiveText}
                    ...
                    {aiEnabled && (
                      <Button
                        ...
                        aria-label={`Ask AI for section ${sectionNumber} introduction`}
                        onClick={(e) => {
                          e.stopPropagation();
                          setShowAIIntroDialog(true);
                        }}
                      >
                        <Sparkles className="w-3 h-3" style={{ stroke: 'url(#ai-gradient-intro)' }} aria-hidden="true" focusable="false" />
                        ...
                        <span className="bg-gradient-to-r from-[hsl(211,100%,50%)] to-[hsl(270,80%,55%)] bg-clip-text text-transparent font-medium" aria-hidden="true">Ask AI</span>
                      </Button>
                    )}
                  </div>
                </div>
        ...
        <DialogContent className="w-[95vw] max-w-[1100px] max-h-[90vh] flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto min-h-0 pr-1">
            ...
            <div className="mt-4 rounded-xl border border-border bg-muted/20 p-4">
              <label className="text-xs font-semibold text-foreground uppercase tracking-wider mb-2.5 flex items-center gap-1.5"><Target className="w-3.5 h-3.5 text-primary" aria-hidden="true" focusable="false" />Learning Objectives</label>
              <textarea
                value={objectiveText}
            ...
            <div className="mt-4 flex flex-col md:flex-row gap-0 md:gap-0">
              ...
              <div className="flex md:hidden items-center gap-3 py-3 px-2">
                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-border to-transparent" />
                <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest">vs</span>
                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-border to-transparent" />
              </div>

              {/* Exclusions */}
              <div className="flex-1 rounded-xl border border-border bg-muted/20 p-4">
                <label className="text-xs font-semibold text-foreground uppercase tracking-wider mb-2.5 flex items-center gap-1.5"><XCircle className="w-3.5 h-3.5 text-destructive/70" aria-hidden="true" focusable="false" />Exclusions</label>
              <textarea
                  value={exclusions}
