      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className={cn(
            ...
            isDragOver ? "bg-primary/50" : "bg-foreground/15 opacity-40",
          ...
          <div className={cn(
            ...
            isDragOver
              ? "w-9 h-9 border-primary border-dashed bg-primary/5 scale-110"
              : "w-7 h-7 border-foreground/20 opacity-40 group-hover/add:opacity-100",
            (forceOpen || isPopoverOpen) && "opacity-100"
          )}>
