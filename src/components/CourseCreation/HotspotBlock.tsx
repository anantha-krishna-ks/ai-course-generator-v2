    ...
    <div className="flex flex-col h-[520px] max-h-[80vh] bg-background">
      ...
      <Tabs defaultValue="content" className="flex-1 flex flex-col overflow-hidden min-h-0">
        ...
        <div className="px-4 pt-3 pb-2">
          <TabsList className="grid grid-cols-2 w-full h-auto rounded-full bg-transparent border border-border/60 p-[3px]">
            <TabsTrigger
              value="content"
              className="relative z-10 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold rounded-full border border-transparent text-muted-foreground transition-colors duration-300 data-[state=active]:bg-gradient-to-b data-[state=active]:from-background data-[state=active]:to-muted/40 data-[state=active]:text-foreground data-[state=active]:shadow-[0_1px_2px_0_rgba(0,0,0,0.06),inset_0_1px_0_0_rgba(255,255,255,0.6)]"
            >
              <Pencil className="w-3 h-3" aria-hidden="true" focusable="false" />
              Content
            </TabsTrigger>
