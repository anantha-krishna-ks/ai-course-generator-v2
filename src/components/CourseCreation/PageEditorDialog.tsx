...
import { FileText, LayoutGrid, Plus, Sparkles, Type, ImageIcon, Video, FileText as DocIcon, Layers, MoreHorizontal, MessageCircleQuestion, Mic, Eye, ChevronLeft, ChevronRight, ChevronUp, ChevronDown, MoreHorizontal as Dots, Undo2, Send, BookOpen, GripVertical, Pencil, Copy, Trash2, Check, ArrowLeft, Loader2 } from "lucide-react";
...
export function PageEditorDialog({ open, onClose, pageTitle, onPageTitleChange, aiEnabled = false, aiOptions = null, onAiOptionsChange, courseItems = [], currentPageId, onRenameItem, onDuplicateItem, onDeleteItem, onAddPageToSection, onReorderItems, onReorderChildItems, onNavigateToPage, onAddItem, initialBlocks, onBlocksChange, sectionObjectives = "", onSectionObjectivesChange, sectionThumbnailUrl, onSectionThumbnailChange, onPreview }: PageEditorDialogProps) {
  ...
  const getVariantContent = (type: string, variant?: string): string => {
    ...
    switch (variant) {
      ...
      case "three-columns":
        return '<!--layout:three-columns--><h2>Column 1</h2><p>Start writing here...</p><!--col-break--><h2>Column 2</h2><p>Start writing here...</p><!--col-break--><h2>Column 3</h2><p>Start writing here...</p>';
      default:
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div
            className={cn(
              ...
              sidebarCollapsed ? "w-0 overflow-hidden border-r-0" : "w-[360px]"
            )}
          >
