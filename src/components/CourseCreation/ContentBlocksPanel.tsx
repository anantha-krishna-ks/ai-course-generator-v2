        ...
        <div
          ...
          className={cn(
            ...
            locked
              ...
              : "border-border/40 hover:border-primary/30 hover:shadow-[0_2px_8px_-2px_hsl(var(--primary)/0.12)] hover:bg-[#ffffff] cursor-grab active:cursor-grabbing active:scale-[0.97]"
          )}
        >
          {locked && (
