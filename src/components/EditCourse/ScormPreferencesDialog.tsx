...
import { Sliders, Upload, X, CheckCircle2, XCircle, Check, ArrowLeft } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
/**
 * Reusable SCORM preferences body — render inside any container
 * (used inline by CreateCourseDialog and inside the standalone dialog).
 */
export function ScormPreferencesContent({
  onBack,
  onSave,
  showHeader = true,
}: {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] p-0 overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto scorm-dark-scrollbar p-4 sm:p-5">
          <style>{`
