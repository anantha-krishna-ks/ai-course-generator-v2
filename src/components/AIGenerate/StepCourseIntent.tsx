...
import { Upload, Lightbulb, Sparkles, Wand2 } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          {/* Inline example tip — visible when empty, dismissible */}
          <AnimatePresence>
            {showTip && (
              <motion.div
                ...
                className="mt-2 flex items-start gap-2.5 rounded-xl border border-border bg-muted/40 px-3 py-2.5"
              >
                <Lightbulb className="w-3.5 h-3.5 text-primary shrink-0 mt-0.5" aria-hidden="true" focusable="false" />
                <div className="flex-1 min-w-0">
                  <p className="text-[11px] font-medium text-muted-foreground mb-1">Need inspiration?</p>
                  <p className="text-xs text-foreground/80 italic leading-relaxed">{EXAMPLE_TEXT}</p>
